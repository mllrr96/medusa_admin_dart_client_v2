...
/// @nodoc
mixin _$PostReturnsShippingReq {
...
/// Create a copy of PostReturnsShippingReq
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$PostReturnsShippingReqCopyWith<PostReturnsShippingReq> get copyWith => _$PostReturnsShippingReqCopyWithImpl<PostReturnsShippingReq>(this as PostReturnsShippingReq, _$identity);

  /// Serializes this PostReturnsShippingReq to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PostReturnsShippingReq&&(identical(other.shippingOptionId, shippingOptionId) || other.shippingOptionId == shippingOptionId)&&(identical(other.customAmount, customAmount) || other.customAmount == customAmount)&&(identical(other.description, description) || other.description == description)&&(identical(other.internalNote, internalNote) || other.internalNote == internalNote)&&const DeepCollectionEquality().equals(other.metadata, metadata));
}
...
@override
String toString() {
  return 'PostReturnsShippingReq(shippingOptionId: $shippingOptionId, customAmount: $customAmount, description: $description, internalNote: $internalNote, metadata: $metadata)';
}
...
/// @nodoc
abstract mixin class $PostReturnsShippingReqCopyWith<$Res>  {
  factory $PostReturnsShippingReqCopyWith(PostReturnsShippingReq value, $Res Function(PostReturnsShippingReq) _then) = _$PostReturnsShippingReqCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PostReturnsShippingReqCopyWithImpl<$Res>
    implements $PostReturnsShippingReqCopyWith<$Res> {
  _$PostReturnsShippingReqCopyWithImpl(this._self, this._then);

  final PostReturnsShippingReq _self;
  final $Res Function(PostReturnsShippingReq) _then;
...
/// Adds pattern-matching-related methods to [PostReturnsShippingReq].
extension PostReturnsShippingReqPatterns on PostReturnsShippingReq {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PostReturnsShippingReq value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PostReturnsShippingReq() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PostReturnsShippingReq value)  $default,){
final _that = this;
switch (_that) {
case _PostReturnsShippingReq():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PostReturnsShippingReq value)?  $default,){
final _that = this;
switch (_that) {
case _PostReturnsShippingReq() when $default != null:
return $default(_that);case _:
...
class _PostReturnsShippingReq implements PostReturnsShippingReq {
  const _PostReturnsShippingReq({@JsonKey(name: 'shipping_option_id') required this.shippingOptionId, @JsonKey(name: 'custom_amount') this.customAmount, this.description, @JsonKey(name: 'internal_note') this.internalNote, final  Map<String, dynamic>? metadata}): _metadata = metadata;
  factory _PostReturnsShippingReq.fromJson(Map<String, dynamic> json) => _$PostReturnsShippingReqFromJson(json);
...
@pragma('vm:prefer-inline')
_$PostReturnsShippingReqCopyWith<_PostReturnsShippingReq> get copyWith => __$PostReturnsShippingReqCopyWithImpl<_PostReturnsShippingReq>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PostReturnsShippingReqToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PostReturnsShippingReq&&(identical(other.shippingOptionId, shippingOptionId) || other.shippingOptionId == shippingOptionId)&&(identical(other.customAmount, customAmount) || other.customAmount == customAmount)&&(identical(other.description, description) || other.description == description)&&(identical(other.internalNote, internalNote) || other.internalNote == internalNote)&&const DeepCollectionEquality().equals(other._metadata, _metadata));
}
...
/// @nodoc
abstract mixin class _$PostReturnsShippingReqCopyWith<$Res> implements $PostReturnsShippingReqCopyWith<$Res> {
  factory _$PostReturnsShippingReqCopyWith(_PostReturnsShippingReq value, $Res Function(_PostReturnsShippingReq) _then) = __$PostReturnsShippingReqCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'shipping_option_id') String shippingOptionId,@JsonKey(name: 'custom_amount') int? customAmount, String? description,@JsonKey(name: 'internal_note') String? internalNote, Map<String, dynamic>? metadata
});
...
/// @nodoc
class __$PostReturnsShippingReqCopyWithImpl<$Res>
    implements _$PostReturnsShippingReqCopyWith<$Res> {
  __$PostReturnsShippingReqCopyWithImpl(this._self, this._then);

  final _PostReturnsShippingReq _self;
  final $Res Function(_PostReturnsShippingReq) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? shippingOptionId = null,Object? customAmount = freezed,Object? description = freezed,Object? internalNote = freezed,Object? metadata = freezed,}) {
  return _then(_PostReturnsShippingReq(
shippingOptionId: null == shippingOptionId ? _self.shippingOptionId : shippingOptionId // ignore: cast_nullable_to_non_nullable
as String,customAmount: freezed == customAmount ? _self.customAmount : customAmount // ignore: cast_nullable_to_non_nullable
as int?,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,internalNote: freezed == internalNote ? _self.internalNote : internalNote // ignore: cast_nullable_to_non_nullable
