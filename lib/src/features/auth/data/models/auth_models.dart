...
@freezed
abstract class PostActorTypeAuthProviderReq with _$PostActorTypeAuthProviderReq {
...
@freezed
abstract class PostActorTypeAuthProviderRegisterReq with _$PostActorTypeAuthProviderRegisterReq {
  const factory PostActorTypeAuthProviderRegisterReq({
    required Map<String, dynamic> payload,
  }) = _PostActorTypeAuthProviderRegisterReq;

  factory PostActorTypeAuthProviderRegisterReq.fromJson(Map<String, dynamic> json) =>
      _$PostActorTypeAuthProviderRegisterReqFromJson(json);
}

@freezed
abstract class PostActorTypeAuthProviderResetPasswordReq with _$PostActorTypeAuthProviderResetPasswordReq {
  const factory PostActorTypeAuthProviderResetPasswordReq({
    required Map<String, dynamic> payload,
  }) = _PostActorTypeAuthProviderResetPasswordReq;

  factory PostActorTypeAuthProviderResetPasswordReq.fromJson(Map<String, dynamic> json) =>
      _$PostActorTypeAuthProviderResetPasswordReqFromJson(json);
}

@freezed
abstract class PostActorTypeAuthProviderUpdateReq with _$PostActorTypeAuthProviderUpdateReq {
  const factory PostActorTypeAuthProviderUpdateReq({
    required Map<String, dynamic> payload,
  }) = _PostActorTypeAuthProviderUpdateReq;

  factory PostActorTypeAuthProviderUpdateReq.fromJson(Map<String, dynamic> json) =>
...
@freezed
abstract class PostActorTypeAuthProviderUpdateRes with _$PostActorTypeAuthProviderUpdateRes {
  const factory PostActorTypeAuthProviderUpdateRes({
    required bool success,
  }) = _PostActorTypeAuthProviderUpdateRes;

  factory PostActorTypeAuthProviderUpdateRes.fromJson(Map<String, dynamic> json) =>
