...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Currency&&(identical(other.code, code) || other.code == code)&&(identical(other.symbol, symbol) || other.symbol == symbol)&&(identical(other.symbolNative, symbolNative) || other.symbolNative == symbolNative)&&(identical(other.name, name) || other.name == name));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,symbol,symbolNative,name);

@override
String toString() {
  return 'Currency(code: $code, symbol: $symbol, symbolNative: $symbolNative, name: $name)';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Currency&&(identical(other.code, code) || other.code == code)&&(identical(other.symbol, symbol) || other.symbol == symbol)&&(identical(other.symbolNative, symbolNative) || other.symbolNative == symbolNative)&&(identical(other.name, name) || other.name == name));
}
