...
class _DraftOrdersApi implements DraftOrdersApi {
  _DraftOrdersApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<DraftOrderListResponse> getDraftOrders({
    ...
    final _options = _setStreamType<DraftOrderListResponse>(
    ...
    late DraftOrderListResponse _value;
    try {
      _value = DraftOrderListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<DraftOrderResponse> getDraftOrder(String id, {String? fields}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'fields': fields};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<void> cancelEdit(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> createEdit(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> confirmEdit(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> addItems(String id, AddDraftOrderItems body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<void> deleteItem(String id, String actionId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<DraftOrderPreviewResponse> deletePromotions(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DraftOrderPreviewResponse _value;
    try {
      _value = DraftOrderPreviewResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<void> requestEdit(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> deleteShippingMethod(String id, String methodId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> deleteNewShippingMethod(String id, String actionId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
