...
mixin _$SalesChannel {
 ...
 String get id; String get name; String? get description; bool get isDisabled; DateTime get createdAt; DateTime get updatedAt; DateTime? get deletedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,isDisabled,createdAt,updatedAt,deletedAt);

@override
String toString() {
  return 'SalesChannel(id: $id, name: $name, description: $description, isDisabled: $isDisabled, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
}
...
@useResult
$Res call({
 String id, String name, String? description, bool isDisabled, DateTime createdAt, DateTime updatedAt, DateTime? deletedAt
});
...
/// Create a copy of SalesChannel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? isDisabled = null,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  bool isDisabled,  DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SalesChannel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.isDisabled,_that.createdAt,_that.updatedAt,_that.deletedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String? description,  bool isDisabled,  DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt)  $default,) {final _that = this;
switch (_that) {
case _SalesChannel():
return $default(_that.id,_that.name,_that.description,_that.isDisabled,_that.createdAt,_that.updatedAt,_that.deletedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String? description,  bool isDisabled,  DateTime createdAt,  DateTime updatedAt,  DateTime? deletedAt)?  $default,) {final _that = this;
switch (_that) {
case _SalesChannel() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.isDisabled,_that.createdAt,_that.updatedAt,_that.deletedAt);case _:
  return null;
...
class _SalesChannel implements SalesChannel {
  const _SalesChannel({required this.id, required this.name, this.description, required this.isDisabled, required this.createdAt, required this.updatedAt, this.deletedAt});
...
/// Create a copy of SalesChannel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? isDisabled = null,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,}) {
