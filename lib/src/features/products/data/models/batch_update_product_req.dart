...
part 'batch_update_product_req.freezed.dart';
part 'batch_update_product_req.g.dart';

@freezed
abstract class BatchUpdateProductReq with _$BatchUpdateProductReq {
  const factory BatchUpdateProductReq({
    required String id,
    String? title,
    String? subtitle,
    String? description,
