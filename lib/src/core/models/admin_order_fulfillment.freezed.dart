...
@override
String toString() {
  return 'AdminOrderFulfillment(id: $id, location_id: $location_id, packed_at: $packed_at, shipped_at: $shipped_at, delivered_at: $delivered_at, canceled_at: $canceled_at, data: $data, provider_id: $provider_id, shipping_option_id: $shipping_option_id, metadata: $metadata, created_at: $created_at, updated_at: $updated_at, requires_shipping: $requires_shipping)';
}
...
/// @nodoc
abstract mixin class $AdminOrderFulfillmentCopyWith<$Res>  {
  factory $AdminOrderFulfillmentCopyWith(AdminOrderFulfillment value, $Res Function(AdminOrderFulfillment) _then) = _$AdminOrderFulfillmentCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AdminOrderFulfillmentCopyWithImpl<$Res>
    implements $AdminOrderFulfillmentCopyWith<$Res> {
  _$AdminOrderFulfillmentCopyWithImpl(this._self, this._then);

  final AdminOrderFulfillment _self;
  final $Res Function(AdminOrderFulfillment) _then;
...
/// Adds pattern-matching-related methods to [AdminOrderFulfillment].
extension AdminOrderFulfillmentPatterns on AdminOrderFulfillment {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminOrderFulfillment value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminOrderFulfillment() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminOrderFulfillment value)  $default,){
final _that = this;
switch (_that) {
case _AdminOrderFulfillment():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminOrderFulfillment value)?  $default,){
final _that = this;
switch (_that) {
case _AdminOrderFulfillment() when $default != null:
return $default(_that);case _:
...
class _AdminOrderFulfillment implements AdminOrderFulfillment {
  const _AdminOrderFulfillment({required this.id, required this.location_id, required this.packed_at, required this.shipped_at, required this.delivered_at, required this.canceled_at, required final  Map<String, dynamic> data, required this.provider_id, required this.shipping_option_id, required final  Map<String, dynamic> metadata, required this.created_at, required this.updated_at, required this.requires_shipping}): _data = data,_metadata = metadata;
  factory _AdminOrderFulfillment.fromJson(Map<String, dynamic> json) => _$AdminOrderFulfillmentFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminOrderFulfillmentCopyWith<_AdminOrderFulfillment> get copyWith => __$AdminOrderFulfillmentCopyWithImpl<_AdminOrderFulfillment>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminOrderFulfillmentToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminOrderFulfillment&&(identical(other.id, id) || other.id == id)&&(identical(other.location_id, location_id) || other.location_id == location_id)&&(identical(other.packed_at, packed_at) || other.packed_at == packed_at)&&(identical(other.shipped_at, shipped_at) || other.shipped_at == shipped_at)&&(identical(other.delivered_at, delivered_at) || other.delivered_at == delivered_at)&&(identical(other.canceled_at, canceled_at) || other.canceled_at == canceled_at)&&const DeepCollectionEquality().equals(other._data, _data)&&(identical(other.provider_id, provider_id) || other.provider_id == provider_id)&&(identical(other.shipping_option_id, shipping_option_id) || other.shipping_option_id == shipping_option_id)&&const DeepCollectionEquality().equals(other._metadata, _metadata)&&(identical(other.created_at, created_at) || other.created_at == created_at)&&(identical(other.updated_at, updated_at) || other.updated_at == updated_at)&&(identical(other.requires_shipping, requires_shipping) || other.requires_shipping == requires_shipping));
}
...
/// @nodoc
abstract mixin class _$AdminOrderFulfillmentCopyWith<$Res> implements $AdminOrderFulfillmentCopyWith<$Res> {
  factory _$AdminOrderFulfillmentCopyWith(_AdminOrderFulfillment value, $Res Function(_AdminOrderFulfillment) _then) = __$AdminOrderFulfillmentCopyWithImpl;
@override @useResult
$Res call({
 String id, String location_id, String packed_at, String shipped_at, String delivered_at, String canceled_at, Map<String, dynamic> data, String provider_id, String shipping_option_id, Map<String, dynamic> metadata, String created_at, String updated_at, bool requires_shipping
});
...
/// @nodoc
class __$AdminOrderFulfillmentCopyWithImpl<$Res>
    implements _$AdminOrderFulfillmentCopyWith<$Res> {
  __$AdminOrderFulfillmentCopyWithImpl(this._self, this._then);

  final _AdminOrderFulfillment _self;
  final $Res Function(_AdminOrderFulfillment) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? location_id = null,Object? packed_at = null,Object? shipped_at = null,Object? delivered_at = null,Object? canceled_at = null,Object? data = null,Object? provider_id = null,Object? shipping_option_id = null,Object? metadata = null,Object? created_at = null,Object? updated_at = null,Object? requires_shipping = null,}) {
  return _then(_AdminOrderFulfillment(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,location_id: null == location_id ? _self.location_id : location_id // ignore: cast_nullable_to_non_nullable
as String,packed_at: null == packed_at ? _self.packed_at : packed_at // ignore: cast_nullable_to_non_nullable
as String,shipped_at: null == shipped_at ? _self.shipped_at : shipped_at // ignore: cast_nullable_to_non_nullable
