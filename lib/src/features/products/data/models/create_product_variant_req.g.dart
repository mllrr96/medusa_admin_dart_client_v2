...
_CreateProductVariantReq _$CreateProductVariantReqFromJson(
  ...
  inventoryItems: (json['inventory_items'] as List<dynamic>?)
      ?.map(
        (e) => CreateProductVariantInventoryKitReq.fromJson(
...
Map<String, dynamic> _$CreateProductVariantReqToJson(
  _CreateProductVariantReq instance,
) => <String, dynamic>{
