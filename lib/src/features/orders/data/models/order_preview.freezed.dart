...
mixin _$OrderPreview {
 ...
 int get returnRequestedTotal; OrderChange get orderChange; List<OrderShippingMethod> get shippingMethods; List<OrderLineItem> get items; String get currencyCode; int get version; String get id; String get regionId; String get customerId; String get salesChannelId; String get email; int? get displayId; OrderAddress get shippingAddress; OrderAddress get billingAddress; List<PaymentCollection> get paymentCollections; String get paymentStatus; List<OrderFulfillment> get fulfillments; String get fulfillmentStatus; List<OrderTransaction> get transactions; BaseOrderSummary get summary; Map<String, dynamic>? get metadata; DateTime? get createdAt; DateTime? get updatedAt; int get originalItemTotal; int get originalItemSubtotal; int get originalItemTaxTotal; int get itemTotal; int get itemSubtotal; int get itemTaxTotal; int get originalTotal; int get originalSubtotal; int get originalTaxTotal; int get total; int get subtotal; int get taxTotal; int get discountTotal; int get discountTaxTotal; int get giftCardTotal; int get giftCardTaxTotal; int get shippingTotal; int get shippingSubtotal; int get shippingTaxTotal; int get originalShippingTotal; int get originalShippingSubtotal; int get originalShippingTaxTotal;// required Customer customer,
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int returnRequestedTotal,  OrderChange orderChange,  List<OrderShippingMethod> shippingMethods,  List<OrderLineItem> items,  String currencyCode,  int version,  String id,  String regionId,  String customerId,  String salesChannelId,  String email,  int? displayId,  OrderAddress shippingAddress,  OrderAddress billingAddress,  List<PaymentCollection> paymentCollections,  String paymentStatus,  List<OrderFulfillment> fulfillments,  String fulfillmentStatus,  List<OrderTransaction> transactions,  BaseOrderSummary summary,  Map<String, dynamic>? metadata,  DateTime? createdAt,  DateTime? updatedAt,  int originalItemTotal,  int originalItemSubtotal,  int originalItemTaxTotal,  int itemTotal,  int itemSubtotal,  int itemTaxTotal,  int originalTotal,  int originalSubtotal,  int originalTaxTotal,  int total,  int subtotal,  int taxTotal,  int discountTotal,  int discountTaxTotal,  int giftCardTotal,  int giftCardTaxTotal,  int shippingTotal,  int shippingSubtotal,  int shippingTaxTotal,  int originalShippingTotal,  int originalShippingSubtotal,  int originalShippingTaxTotal,  String status,  int creditLineTotal)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderPreview() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int returnRequestedTotal,  OrderChange orderChange,  List<OrderShippingMethod> shippingMethods,  List<OrderLineItem> items,  String currencyCode,  int version,  String id,  String regionId,  String customerId,  String salesChannelId,  String email,  int? displayId,  OrderAddress shippingAddress,  OrderAddress billingAddress,  List<PaymentCollection> paymentCollections,  String paymentStatus,  List<OrderFulfillment> fulfillments,  String fulfillmentStatus,  List<OrderTransaction> transactions,  BaseOrderSummary summary,  Map<String, dynamic>? metadata,  DateTime? createdAt,  DateTime? updatedAt,  int originalItemTotal,  int originalItemSubtotal,  int originalItemTaxTotal,  int itemTotal,  int itemSubtotal,  int itemTaxTotal,  int originalTotal,  int originalSubtotal,  int originalTaxTotal,  int total,  int subtotal,  int taxTotal,  int discountTotal,  int discountTaxTotal,  int giftCardTotal,  int giftCardTaxTotal,  int shippingTotal,  int shippingSubtotal,  int shippingTaxTotal,  int originalShippingTotal,  int originalShippingSubtotal,  int originalShippingTaxTotal,  String status,  int creditLineTotal)  $default,) {final _that = this;
switch (_that) {
case _OrderPreview():
return $default(_that.returnRequestedTotal,_that.orderChange,_that.shippingMethods,_that.items,_that.currencyCode,_that.version,_that.id,_that.regionId,_that.customerId,_that.salesChannelId,_that.email,_that.displayId,_that.shippingAddress,_that.billingAddress,_that.paymentCollections,_that.paymentStatus,_that.fulfillments,_that.fulfillmentStatus,_that.transactions,_that.summary,_that.metadata,_that.createdAt,_that.updatedAt,_that.originalItemTotal,_that.originalItemSubtotal,_that.originalItemTaxTotal,_that.itemTotal,_that.itemSubtotal,_that.itemTaxTotal,_that.originalTotal,_that.originalSubtotal,_that.originalTaxTotal,_that.total,_that.subtotal,_that.taxTotal,_that.discountTotal,_that.discountTaxTotal,_that.giftCardTotal,_that.giftCardTaxTotal,_that.shippingTotal,_that.shippingSubtotal,_that.shippingTaxTotal,_that.originalShippingTotal,_that.originalShippingSubtotal,_that.originalShippingTaxTotal,_that.status,_that.creditLineTotal);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int returnRequestedTotal,  OrderChange orderChange,  List<OrderShippingMethod> shippingMethods,  List<OrderLineItem> items,  String currencyCode,  int version,  String id,  String regionId,  String customerId,  String salesChannelId,  String email,  int? displayId,  OrderAddress shippingAddress,  OrderAddress billingAddress,  List<PaymentCollection> paymentCollections,  String paymentStatus,  List<OrderFulfillment> fulfillments,  String fulfillmentStatus,  List<OrderTransaction> transactions,  BaseOrderSummary summary,  Map<String, dynamic>? metadata,  DateTime? createdAt,  DateTime? updatedAt,  int originalItemTotal,  int originalItemSubtotal,  int originalItemTaxTotal,  int itemTotal,  int itemSubtotal,  int itemTaxTotal,  int originalTotal,  int originalSubtotal,  int originalTaxTotal,  int total,  int subtotal,  int taxTotal,  int discountTotal,  int discountTaxTotal,  int giftCardTotal,  int giftCardTaxTotal,  int shippingTotal,  int shippingSubtotal,  int shippingTaxTotal,  int originalShippingTotal,  int originalShippingSubtotal,  int originalShippingTaxTotal,  String status,  int creditLineTotal)?  $default,) {final _that = this;
switch (_that) {
case _OrderPreview() when $default != null:
return $default(_that.returnRequestedTotal,_that.orderChange,_that.shippingMethods,_that.items,_that.currencyCode,_that.version,_that.id,_that.regionId,_that.customerId,_that.salesChannelId,_that.email,_that.displayId,_that.shippingAddress,_that.billingAddress,_that.paymentCollections,_that.paymentStatus,_that.fulfillments,_that.fulfillmentStatus,_that.transactions,_that.summary,_that.metadata,_that.createdAt,_that.updatedAt,_that.originalItemTotal,_that.originalItemSubtotal,_that.originalItemTaxTotal,_that.itemTotal,_that.itemSubtotal,_that.itemTaxTotal,_that.originalTotal,_that.originalSubtotal,_that.originalTaxTotal,_that.total,_that.subtotal,_that.taxTotal,_that.discountTotal,_that.discountTaxTotal,_that.giftCardTotal,_that.giftCardTaxTotal,_that.shippingTotal,_that.shippingSubtotal,_that.shippingTaxTotal,_that.originalShippingTotal,_that.originalShippingSubtotal,_that.originalShippingTaxTotal,_that.status,_that.creditLineTotal);case _:
  return null;
...
class _OrderPreview implements OrderPreview {
  const _OrderPreview({required this.returnRequestedTotal, required this.orderChange, required final  List<OrderShippingMethod> shippingMethods, required final  List<OrderLineItem> items, required this.currencyCode, required this.version, required this.id, required this.regionId, required this.customerId, required this.salesChannelId, required this.email, this.displayId, required this.shippingAddress, required this.billingAddress, required final  List<PaymentCollection> paymentCollections, required this.paymentStatus, required final  List<OrderFulfillment> fulfillments, required this.fulfillmentStatus, required final  List<OrderTransaction> transactions, required this.summary, final  Map<String, dynamic>? metadata, this.createdAt, this.updatedAt, required this.originalItemTotal, required this.originalItemSubtotal, required this.originalItemTaxTotal, required this.itemTotal, required this.itemSubtotal, required this.itemTaxTotal, required this.originalTotal, required this.originalSubtotal, required this.originalTaxTotal, required this.total, required this.subtotal, required this.taxTotal, required this.discountTotal, required this.discountTaxTotal, required this.giftCardTotal, required this.giftCardTaxTotal, required this.shippingTotal, required this.shippingSubtotal, required this.shippingTaxTotal, required this.originalShippingTotal, required this.originalShippingSubtotal, required this.originalShippingTaxTotal, required this.status, required this.creditLineTotal}): _shippingMethods = shippingMethods,_items = items,_paymentCollections = paymentCollections,_fulfillments = fulfillments,_transactions = transactions,_metadata = metadata;
...
@override List<OrderShippingMethod> get shippingMethods {
