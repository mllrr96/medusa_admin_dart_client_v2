...
@freezed
abstract class CreateProductVariantInventoryKitReq
    with _$CreateProductVariantInventoryKitReq {
  ...
  factory CreateProductVariantInventoryKitReq.fromJson(
    Map<String, dynamic> json,
  ) => _$CreateProductVariantInventoryKitReqFromJson(json);
}
