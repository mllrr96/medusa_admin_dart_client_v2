...
as List<AdminGiftCard>?,taxRate: freezed == taxRate ? _self.taxRate : taxRate // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey(name: 'gift_cards') List<AdminGiftCard>? get giftCards {
