...
part 'create_product_req.freezed.dart';
part 'create_product_req.g.dart';

@freezed
abstract class CreateProductReq with _$CreateProductReq {
  const factory CreateProductReq({
    ...
    required List<CreateProductOptionReq> options,
    List<CreateProductVariantReq>? variants,
