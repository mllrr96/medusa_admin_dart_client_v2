...
as Claim,order: null == order ? _self.order : order // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int version, @JsonKey(name: 'change_type')  String? changeType, @JsonKey(name: 'order_id')  String orderId, @JsonKey(name: 'return_id')  String returnId, @JsonKey(name: 'exchange_id')  String exchangeId, @JsonKey(name: 'claim_id')  String claimId, @JsonKey(name: 'return_order')  Return returnOrder,  Exchange exchange,  Claim claim,  Order order,  String status, @JsonKey(name: 'requested_by')  String requestedBy, @JsonKey(name: 'requested_at')  DateTime? requestedAt, @JsonKey(name: 'confirmed_by')  String confirmedBy, @JsonKey(name: 'confirmed_at')  DateTime? confirmedAt, @JsonKey(name: 'declined_by')  String declinedBy, @JsonKey(name: 'declined_reason')  String declinedReason,  Map<String, dynamic> metadata, @JsonKey(name: 'declined_at')  DateTime? declinedAt, @JsonKey(name: 'canceled_by')  String canceledBy, @JsonKey(name: 'canceled_at')  DateTime? canceledAt, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderChange() when $default != null:
return $default(_that.id,_that.version,_that.changeType,_that.orderId,_that.returnId,_that.exchangeId,_that.claimId,_that.returnOrder,_that.exchange,_that.claim,_that.order,_that.status,_that.requestedBy,_that.requestedAt,_that.confirmedBy,_that.confirmedAt,_that.declinedBy,_that.declinedReason,_that.metadata,_that.declinedAt,_that.canceledBy,_that.canceledAt,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int version, @JsonKey(name: 'change_type')  String? changeType, @JsonKey(name: 'order_id')  String orderId, @JsonKey(name: 'return_id')  String returnId, @JsonKey(name: 'exchange_id')  String exchangeId, @JsonKey(name: 'claim_id')  String claimId, @JsonKey(name: 'return_order')  Return returnOrder,  Exchange exchange,  Claim claim,  Order order,  String status, @JsonKey(name: 'requested_by')  String requestedBy, @JsonKey(name: 'requested_at')  DateTime? requestedAt, @JsonKey(name: 'confirmed_by')  String confirmedBy, @JsonKey(name: 'confirmed_at')  DateTime? confirmedAt, @JsonKey(name: 'declined_by')  String declinedBy, @JsonKey(name: 'declined_reason')  String declinedReason,  Map<String, dynamic> metadata, @JsonKey(name: 'declined_at')  DateTime? declinedAt, @JsonKey(name: 'canceled_by')  String canceledBy, @JsonKey(name: 'canceled_at')  DateTime? canceledAt, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _OrderChange():
return $default(_that.id,_that.version,_that.changeType,_that.orderId,_that.returnId,_that.exchangeId,_that.claimId,_that.returnOrder,_that.exchange,_that.claim,_that.order,_that.status,_that.requestedBy,_that.requestedAt,_that.confirmedBy,_that.confirmedAt,_that.declinedBy,_that.declinedReason,_that.metadata,_that.declinedAt,_that.canceledBy,_that.canceledAt,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int version, @JsonKey(name: 'change_type')  String? changeType, @JsonKey(name: 'order_id')  String orderId, @JsonKey(name: 'return_id')  String returnId, @JsonKey(name: 'exchange_id')  String exchangeId, @JsonKey(name: 'claim_id')  String claimId, @JsonKey(name: 'return_order')  Return returnOrder,  Exchange exchange,  Claim claim,  Order order,  String status, @JsonKey(name: 'requested_by')  String requestedBy, @JsonKey(name: 'requested_at')  DateTime? requestedAt, @JsonKey(name: 'confirmed_by')  String confirmedBy, @JsonKey(name: 'confirmed_at')  DateTime? confirmedAt, @JsonKey(name: 'declined_by')  String declinedBy, @JsonKey(name: 'declined_reason')  String declinedReason,  Map<String, dynamic> metadata, @JsonKey(name: 'declined_at')  DateTime? declinedAt, @JsonKey(name: 'canceled_by')  String canceledBy, @JsonKey(name: 'canceled_at')  DateTime? canceledAt, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _OrderChange() when $default != null:
return $default(_that.id,_that.version,_that.changeType,_that.orderId,_that.returnId,_that.exchangeId,_that.claimId,_that.returnOrder,_that.exchange,_that.claim,_that.order,_that.status,_that.requestedBy,_that.requestedAt,_that.confirmedBy,_that.confirmedAt,_that.declinedBy,_that.declinedReason,_that.metadata,_that.declinedAt,_that.canceledBy,_that.canceledAt,_that.createdAt,_that.updatedAt);case _:
  return null;
...
@override $ReturnCopyWith<$Res> get returnOrder;@override $ClaimCopyWith<$Res> get claim;@override $OrderCopyWith<$Res> get order;
