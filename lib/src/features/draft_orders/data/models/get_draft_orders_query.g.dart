...
_GetDraftOrdersQuery _$GetDraftOrdersQueryFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$GetDraftOrdersQueryToJson(
  _GetDraftOrdersQuery instance,
) => <String, dynamic>{
  ...
  'with_deleted': instance.withDeleted,
};
