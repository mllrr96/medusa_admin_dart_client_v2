...
class _AuthApi implements AuthApi {
  ...
  Future<AuthAdminSessionResponse> login() async {
    ...
    late AuthAdminSessionResponse _value;
    try {
      _value = AuthAdminSessionResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<AuthResponse> authProviderCallback(String authProvider) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<AuthResponse> register(
    String authProvider,
    PostActorTypeAuthProviderRegisterReq body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<void> resetPassword(
    String authProvider,
    PostActorTypeAuthProviderResetPasswordReq body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<PostActorTypeAuthProviderUpdateRes> update(
    String authProvider,
    PostActorTypeAuthProviderUpdateReq body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<PostActorTypeAuthProviderUpdateRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PostActorTypeAuthProviderUpdateRes _value;
    try {
      _value = PostActorTypeAuthProviderUpdateRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
