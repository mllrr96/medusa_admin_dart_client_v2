...
class _CurrenciesApi implements CurrenciesApi {
  _CurrenciesApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<CurrenciesListRes> list({Map<String, dynamic>? query}) async {
