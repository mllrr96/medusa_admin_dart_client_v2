...
class _OrdersApi implements OrdersApi {
  ...
  @override
  Future<OrderRes> archive(String id, {Map<String, dynamic>? query}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query ?? <String, dynamic>{});
    queryParameters.removeWhere((k, v) => v == null);
  ...
  @override
  Future<OrderRes> cancel(String id, {Map<String, dynamic>? query}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query ?? <String, dynamic>{});
    queryParameters.removeWhere((k, v) => v == null);
  ...
  Future<OrderChangesResponse> listChanges(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderChangesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderChangesResponse _value;
    try {
      _value = OrderChangesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<OrderRes> complete(String id, {Map<String, dynamic>? query}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query ?? <String, dynamic>{});
    queryParameters.removeWhere((k, v) => v == null);
  ...
  Future<OrderRes> createFulfillment(
    String id,
    PostOrdersFulfillmentsReq body, {
    Map<String, dynamic>? query,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<OrderLineItemsListRes> listLineItems(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderLineItemsListRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderLineItemsListRes _value;
    try {
      _value = OrderLineItemsListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<OrderPreviewResponse> retrievePreview(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderPreviewResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderPreviewResponse _value;
    try {
      _value = OrderPreviewResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<OrderShippingOptionsListRes> listShippingOptions(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderShippingOptionsListRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderShippingOptionsListRes _value;
    try {
      _value = OrderShippingOptionsListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
