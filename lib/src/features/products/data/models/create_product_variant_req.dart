...
import 'package:medusa_admin_dart_client/src/features/products/data/models/create_product_variant_inventory_kit_req.dart';
import 'package:medusa_admin_dart_client/src/features/products/data/models/create_product_variant_price_req.dart';

part 'create_product_variant_req.freezed.dart';
part 'create_product_variant_req.g.dart';

@freezed
abstract class CreateProductVariantReq with _$CreateProductVariantReq {
  const factory CreateProductVariantReq({
