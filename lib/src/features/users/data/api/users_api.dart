...
abstract class UsersApi {
  ...
  @GET('/admin/users')
  Future<AdminUserListResponse> retrieveAll({@Queries() Map<String, dynamic>? queryParameters});

  @GET('/admin/users/me')
  Future<AdminUserResponse> retrieveMe({@Queries() Map<String, dynamic>? queryParameters});

  @GET('/admin/users/{id}')
  Future<AdminUserResponse> retrieve(@Path('id') String id);

  @POST('/admin/users/{id}')
  Future<AdminUserResponse> update(@Path('id') String id, @Body() Map<String, dynamic> body);
