...
class _OrderEditsApi implements OrderEditsApi {
  _OrderEditsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<OrderEditRes> createOrderEdit({
    ...
    final _data = body;
    final _options = _setStreamType<OrderEditRes>(
    ...
    late OrderEditRes _value;
    try {
      _value = OrderEditRes.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  @override
  Future<OrderEditListRes> getOrderEdits({Map<String, dynamic>? query}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.addAll(query ?? <String, dynamic>{});
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderEditListRes>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/order-edits',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderEditListRes _value;
    try {
      _value = OrderEditListRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<OrderEditDeleteRes> cancelOrderEdit({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderEditDeleteRes>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderEditDeleteRes _value;
    try {
      _value = OrderEditDeleteRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<OrderEditPreviewRes> confirmOrderEdit({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<OrderEditPreviewRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late OrderEditPreviewRes _value;
    try {
      _value = OrderEditPreviewRes.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<OrderEditPreviewRes> updateOrderItemQuantity({
    ...
    final _options = _setStreamType<OrderEditPreviewRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/order-edits/${id}/items/${itemId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<OrderEditPreviewRes> updateShippingMethodAction({
    ...
    final _options = _setStreamType<OrderEditPreviewRes>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/order-edits/${id}/shipping-method/${actionId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
