...
@override
String toString() {
  return 'AdminReturn(id: $id, status: $status, refundAmount: $refundAmount, orderId: $orderId, items: $items, createdAt: $createdAt, canceledAt: $canceledAt, exchangeId: $exchangeId, locationId: $locationId, claimId: $claimId, orderVersion: $orderVersion, displayId: $displayId, noNotification: $noNotification, receivedAt: $receivedAt)';
}
...
/// @nodoc
class _$AdminReturnCopyWithImpl<$Res>
    implements $AdminReturnCopyWith<$Res> {
  _$AdminReturnCopyWithImpl(this._self, this._then);

  final AdminReturn _self;
  final $Res Function(AdminReturn) _then;

/// Create a copy of AdminReturn
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = freezed,Object? refundAmount = freezed,Object? orderId = null,Object? items = null,Object? createdAt = freezed,Object? canceledAt = freezed,Object? exchangeId = freezed,Object? locationId = freezed,Object? claimId = freezed,Object? orderVersion = null,Object? displayId = null,Object? noNotification = freezed,Object? receivedAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,status: freezed == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as ReturnStatus?,refundAmount: freezed == refundAmount ? _self.refundAmount : refundAmount // ignore: cast_nullable_to_non_nullable
...
/// Adds pattern-matching-related methods to [AdminReturn].
extension AdminReturnPatterns on AdminReturn {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _AdminReturn value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _AdminReturn() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _AdminReturn value)  $default,){
final _that = this;
switch (_that) {
case _AdminReturn():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _AdminReturn value)?  $default,){
final _that = this;
switch (_that) {
case _AdminReturn() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  ReturnStatus? status, @JsonKey(name: 'refund_amount')  int? refundAmount, @JsonKey(name: 'order_id')  String orderId,  List<ReturnItem> items, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'canceled_at')  DateTime? canceledAt, @JsonKey(name: 'exchange_id')  String? exchangeId, @JsonKey(name: 'location_id')  String? locationId, @JsonKey(name: 'claim_id')  String? claimId, @JsonKey(name: 'order_version')  int orderVersion, @JsonKey(name: 'display_id')  int displayId, @JsonKey(name: 'no_notification')  bool? noNotification, @JsonKey(name: 'received_at')  DateTime? receivedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AdminReturn() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  ReturnStatus? status, @JsonKey(name: 'refund_amount')  int? refundAmount, @JsonKey(name: 'order_id')  String orderId,  List<ReturnItem> items, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'canceled_at')  DateTime? canceledAt, @JsonKey(name: 'exchange_id')  String? exchangeId, @JsonKey(name: 'location_id')  String? locationId, @JsonKey(name: 'claim_id')  String? claimId, @JsonKey(name: 'order_version')  int orderVersion, @JsonKey(name: 'display_id')  int displayId, @JsonKey(name: 'no_notification')  bool? noNotification, @JsonKey(name: 'received_at')  DateTime? receivedAt)  $default,) {final _that = this;
switch (_that) {
case _AdminReturn():
return $default(_that.id,_that.status,_that.refundAmount,_that.orderId,_that.items,_that.createdAt,_that.canceledAt,_that.exchangeId,_that.locationId,_that.claimId,_that.orderVersion,_that.displayId,_that.noNotification,_that.receivedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  ReturnStatus? status, @JsonKey(name: 'refund_amount')  int? refundAmount, @JsonKey(name: 'order_id')  String orderId,  List<ReturnItem> items, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'canceled_at')  DateTime? canceledAt, @JsonKey(name: 'exchange_id')  String? exchangeId, @JsonKey(name: 'location_id')  String? locationId, @JsonKey(name: 'claim_id')  String? claimId, @JsonKey(name: 'order_version')  int orderVersion, @JsonKey(name: 'display_id')  int displayId, @JsonKey(name: 'no_notification')  bool? noNotification, @JsonKey(name: 'received_at')  DateTime? receivedAt)?  $default,) {final _that = this;
switch (_that) {
case _AdminReturn() when $default != null:
return $default(_that.id,_that.status,_that.refundAmount,_that.orderId,_that.items,_that.createdAt,_that.canceledAt,_that.exchangeId,_that.locationId,_that.claimId,_that.orderVersion,_that.displayId,_that.noNotification,_that.receivedAt);case _:
  return null;
...
class _AdminReturn implements AdminReturn {
  const _AdminReturn({required this.id, this.status, @JsonKey(name: 'refund_amount') this.refundAmount, @JsonKey(name: 'order_id') required this.orderId, required final  List<ReturnItem> items, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'canceled_at') this.canceledAt, @JsonKey(name: 'exchange_id') this.exchangeId, @JsonKey(name: 'location_id') this.locationId, @JsonKey(name: 'claim_id') this.claimId, @JsonKey(name: 'order_version') required this.orderVersion, @JsonKey(name: 'display_id') required this.displayId, @JsonKey(name: 'no_notification') this.noNotification, @JsonKey(name: 'received_at') this.receivedAt}): _items = items;
  factory _AdminReturn.fromJson(Map<String, dynamic> json) => _$AdminReturnFromJson(json);
...
@pragma('vm:prefer-inline')
_$AdminReturnCopyWith<_AdminReturn> get copyWith => __$AdminReturnCopyWithImpl<_AdminReturn>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$AdminReturnToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AdminReturn&&(identical(other.id, id) || other.id == id)&&(identical(other.status, status) || other.status == status)&&(identical(other.refundAmount, refundAmount) || other.refundAmount == refundAmount)&&(identical(other.orderId, orderId) || other.orderId == orderId)&&const DeepCollectionEquality().equals(other._items, _items)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.canceledAt, canceledAt) || other.canceledAt == canceledAt)&&(identical(other.exchangeId, exchangeId) || other.exchangeId == exchangeId)&&(identical(other.locationId, locationId) || other.locationId == locationId)&&(identical(other.claimId, claimId) || other.claimId == claimId)&&(identical(other.orderVersion, orderVersion) || other.orderVersion == orderVersion)&&(identical(other.displayId, displayId) || other.displayId == displayId)&&(identical(other.noNotification, noNotification) || other.noNotification == noNotification)&&(identical(other.receivedAt, receivedAt) || other.receivedAt == receivedAt));
}
...
/// @nodoc
abstract mixin class _$AdminReturnCopyWith<$Res> implements $AdminReturnCopyWith<$Res> {
  factory _$AdminReturnCopyWith(_AdminReturn value, $Res Function(_AdminReturn) _then) = __$AdminReturnCopyWithImpl;
@override @useResult
$Res call({
 String id, ReturnStatus? status,@JsonKey(name: 'refund_amount') int? refundAmount,@JsonKey(name: 'order_id') String orderId, List<ReturnItem> items,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'canceled_at') DateTime? canceledAt,@JsonKey(name: 'exchange_id') String? exchangeId,@JsonKey(name: 'location_id') String? locationId,@JsonKey(name: 'claim_id') String? claimId,@JsonKey(name: 'order_version') int orderVersion,@JsonKey(name: 'display_id') int displayId,@JsonKey(name: 'no_notification') bool? noNotification,@JsonKey(name: 'received_at') DateTime? receivedAt
});
...
/// @nodoc
class __$AdminReturnCopyWithImpl<$Res>
    implements _$AdminReturnCopyWith<$Res> {
  __$AdminReturnCopyWithImpl(this._self, this._then);

  final _AdminReturn _self;
  final $Res Function(_AdminReturn) _then;
