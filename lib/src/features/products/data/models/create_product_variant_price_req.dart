...
@freezed
abstract class CreateProductVariantPriceReq
    with _$CreateProductVariantPriceReq {
  ...
  factory CreateProductVariantPriceReq.fromJson(Map<String, dynamic> json) =>
      _$CreateProductVariantPriceReqFromJson(json);
}
