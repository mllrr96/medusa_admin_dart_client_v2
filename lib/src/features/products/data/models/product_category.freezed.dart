...
mixin _$ProductCategory {
 ...
 String get id; String get name; String? get description; String get handle;@JsonKey(name: 'is_active') bool get isActive;@JsonKey(name: 'is_internal') bool get isInternal;@JsonKey(name: 'parent_category_id') String? get parentCategoryId; ProductCategory? get parentCategory;@JsonKey(name: 'category_children') List<ProductCategory> get categoryChildren; int? get rank; List<Product>? get products; Map<String, dynamic>? get metadata;@JsonKey(name: 'created_at') DateTime get createdAt;@JsonKey(name: 'updated_at') DateTime get updatedAt;@JsonKey(name: 'deleted_at') DateTime? get deletedAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProductCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.handle, handle) || other.handle == handle)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.isInternal, isInternal) || other.isInternal == isInternal)&&(identical(other.parentCategoryId, parentCategoryId) || other.parentCategoryId == parentCategoryId)&&(identical(other.parentCategory, parentCategory) || other.parentCategory == parentCategory)&&const DeepCollectionEquality().equals(other.categoryChildren, categoryChildren)&&(identical(other.rank, rank) || other.rank == rank)&&const DeepCollectionEquality().equals(other.products, products)&&const DeepCollectionEquality().equals(other.metadata, metadata)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,handle,isActive,isInternal,parentCategoryId,parentCategory,const DeepCollectionEquality().hash(categoryChildren),rank,const DeepCollectionEquality().hash(products),const DeepCollectionEquality().hash(metadata),createdAt,updatedAt,deletedAt);

@override
String toString() {
  return 'ProductCategory(id: $id, name: $name, description: $description, handle: $handle, isActive: $isActive, isInternal: $isInternal, parentCategoryId: $parentCategoryId, parentCategory: $parentCategory, categoryChildren: $categoryChildren, rank: $rank, products: $products, metadata: $metadata, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt)';
}
...
/// Create a copy of ProductCategory
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? description = freezed,Object? handle = null,Object? isActive = null,Object? isInternal = null,Object? parentCategoryId = freezed,Object? parentCategory = freezed,Object? categoryChildren = null,Object? rank = freezed,Object? products = freezed,Object? metadata = freezed,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,}) {
...
as ProductCategory?,categoryChildren: null == categoryChildren ? _self.categoryChildren : categoryChildren // ignore: cast_nullable_to_non_nullable
as List<ProductCategory>,rank: freezed == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
...
class _ProductCategory implements ProductCategory {
  const _ProductCategory({required this.id, required this.name, this.description, required this.handle, @JsonKey(name: 'is_active') required this.isActive, @JsonKey(name: 'is_internal') required this.isInternal, @JsonKey(name: 'parent_category_id') this.parentCategoryId, this.parentCategory, @JsonKey(name: 'category_children') required final  List<ProductCategory> categoryChildren, this.rank, final  List<Product>? products, final  Map<String, dynamic>? metadata, @JsonKey(name: 'created_at') required this.createdAt, @JsonKey(name: 'updated_at') required this.updatedAt, @JsonKey(name: 'deleted_at') this.deletedAt}): _categoryChildren = categoryChildren,_products = products,_metadata = metadata;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProductCategory&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.handle, handle) || other.handle == handle)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.isInternal, isInternal) || other.isInternal == isInternal)&&(identical(other.parentCategoryId, parentCategoryId) || other.parentCategoryId == parentCategoryId)&&(identical(other.parentCategory, parentCategory) || other.parentCategory == parentCategory)&&const DeepCollectionEquality().equals(other._categoryChildren, _categoryChildren)&&(identical(other.rank, rank) || other.rank == rank)&&const DeepCollectionEquality().equals(other._products, _products)&&const DeepCollectionEquality().equals(other._metadata, _metadata)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.deletedAt, deletedAt) || other.deletedAt == deletedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,handle,isActive,isInternal,parentCategoryId,parentCategory,const DeepCollectionEquality().hash(_categoryChildren),rank,const DeepCollectionEquality().hash(_products),const DeepCollectionEquality().hash(_metadata),createdAt,updatedAt,deletedAt);
...
as bool,parentCategoryId: freezed == parentCategoryId ? _self.parentCategoryId : parentCategoryId // ignore: cast_nullable_to_non_nullable
as String?,parentCategory: freezed == parentCategory ? _self.parentCategory : parentCategory // ignore: cast_nullable_to_non_nullable
as ProductCategory?,categoryChildren: null == categoryChildren ? _self._categoryChildren : categoryChildren // ignore: cast_nullable_to_non_nullable
as List<ProductCategory>,rank: freezed == rank ? _self.rank : rank // ignore: cast_nullable_to_non_nullable
